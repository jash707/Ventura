  ...
  return (
    <Card className="p-6 bg-gradient-to-br from-slate-900 to-slate-800 border-slate-700">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-slate-200">Total AUM</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="text-xs text-slate-400 mb-1">Deployed Capital</p>
            <p className="text-lg font-semibold text-slate-200">
              {formatCurrency(totalDeployed)}
            </p>
          </div>
          <div>
            <p className="text-xs text-slate-400 mb-1">Unrealized Gains</p>
